...
### *Importante*
### Se realizó el reemplazo de los archivos .json en los datasets originales debido a problemas de memoria y daños en los commits por el peso de user_items.json en Github, es posible que esto impida realizar los explode o similares, pero sólo se realizó éste cambio para mejorar nuestro repositorio de github, si se reemplaza con los json originales y se abren esos archivos en su respectivo ETL, se podría observar como funciona perfectamente
...
![Descripción de la imagen](./Graficos/Sentimiento.png)
